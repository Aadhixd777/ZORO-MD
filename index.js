    ...
    async function startXeonBotInc() {
        ...
        if (pairingCode && !XeonBotInc.authState.creds.registered) {
            ...
            setTimeout(async () => {
                try {
                    ...
                    console.log(chalk.yellow(`\nPlease enter this code in your WhatsApp app useing zoro:\n1. Open WhatsApp\n2. Go to Settings > Linked Devices\n3. Tap "Link a Device"\n4. Enter the code shown above`));
                } catch (error) {
        ...
        XeonBotInc.ev.on('connection.update', async (s) => {
            ...
            if (connection == "open") {
                ...
                console.log(chalk.yellow(`🦅ZORO CONNECTED TO => ` + JSON.stringify(XeonBotInc.user, null, 2)));
