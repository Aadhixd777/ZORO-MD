const fs = require('fs'); // Fixed: 'Const' -> 'const'
...
async function downloadAndExtractModules() {
    ...
    try {
        ...
        // Fixed: Target folder changed to match your new GitHub repository name
...
async function startBot() {
    ...
    async function startXeonBotInc() {
        ...
        // Combined Message Handling (Cleaned up duplication)
